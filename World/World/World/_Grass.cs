...
namespace World
{
    public class _Grass
    {
        ...
        public _Grass(GraphicsDevice device, Vector3 position, float angle, Texture2D texture, Effect effect, Texture2D snowTexture)
        {
            ...
            {
                // grass
                new VertexPositionTexture(new Vector3(-40, 0,-40),new Vector2(0, 1)),   //v0
                new VertexPositionTexture(new Vector3(40,0,40),new Vector2(1, 0)), //v1
                new VertexPositionTexture(new Vector3(-40,0,40),new Vector2(0, 0)),  //v2
                
                new VertexPositionTexture(new Vector3(40,0,-40),new Vector2(0, 0)), //v0
                new VertexPositionTexture(new Vector3(40,0,40),new Vector2(1, 0)), //v1
                new VertexPositionTexture(new Vector3(-40,0,-40),new Vector2(0, 1)),  //v2
            };
